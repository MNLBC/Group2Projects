...
<script> $(document).ready(function(){ $("#sample").load("modal.html #myModal"); }); </script> 
</head>
<body>
	<div class="banner">
   	  <div class="container">
	  <div class="header-top">
		...
		<div class="col-md-6 col-md-offset-6" id="testDiv">
			...
			<a href="modal.html" class="btn btn-primary" data-toggle="modal" data-target="#loginmodal" id="modalregister">Register</a>
