...
<body>
      ...
      <div class="header_bottom">
        ...
        <div class="menu">
          <ul class="megamenu skyblue">
			<li><a class="color2" href="products.html">Home</a></li>
          ...
          <div class="cart-header">
            ...
            <div class="cart-sec simpleCart_shelfItem">
              ...
              <div class="cart-item-info">
                <h3>
                  <a href="#">Mountain Hopper(XS R034)</a><span>Model
                    No: 3578</span>
                </h3>
                <ul class="qty">
                  <li><p>Size : 5</p></li>
  ...
  <div class="footer">
    <div class="container">
      ...
      <div class="copy">
        <p>
          &copy; Design by <a href="#" target="_blank">ITA 2016
            GROUP 2</a>
        </p>
      </div>
    </div>
