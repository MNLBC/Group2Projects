...
/**
 * DatabaseTransactions Test Class
 * 
 * @author William
 * @since 2016-06-27
 *
...
public class DatabaseTransactionsTest {
   ...
   public void testDeclareOnline() {
      ...
      int result = DatabaseTransactions.declareOnline(new Client("test", "test", "dummyoffline", "password"),
   ...
   public void testDeclareOffline() {
      ...
      DatabaseTransactions.declareOnline(new Client("test", "test", "dummyonline", "password"),
         Timestamp.getTimestamp());
      int result = DatabaseTransactions.declareOnline(new Client("test", "test", "dummyonline", "password"),
         Timestamp.getTimestamp());
      assert (result != 0);
   }
   ...
   public void testSaveMessage() {
      int result =
         DatabaseTransactions.saveMessage(new Message((long) 1, (long) 1, (long) 1, "test", Timestamp.getTimestamp()));
      assert (result != 0);
   }
